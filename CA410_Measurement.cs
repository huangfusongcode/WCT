...
namespace OC_Porject_20191112
{
    class CA410_Measurement
    {
        ...
        public static bool autoconnectflag = false; // auro or manual
        static bool triggerfinish = true;

        public static void CA410_Measure()
        {
        ...
        public static void AutoConnect()
        {
            ...
            catch
            {
                ...
                MessageBox.Show("Connect Fail!", "连接信息", MessageBoxButtons.OK, MessageBoxIcon.Error);
